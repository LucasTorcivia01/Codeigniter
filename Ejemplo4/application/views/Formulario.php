...
<form method="post" action="<?php print site_url("Usuarios/verificar");?>">
		...
		value="<?php print set_value("nombre");?>"><br><br>
		<label for="clave">Clave: </label><br>
		<input type="password" name="clave" 
		value="<?php print set_value("clave");?>"><br><br>
		<label for="clave2">Repita la Clave: </label><br>
		<input type="password" name="clave2"
		value="<?php print set_value("clave2");?>"><br><br>
		<label for="correo">Correo: </label><br>
		<input type="text" name="correo"
		value="<?php print set_value("correo");?>"><br><br>
		...
		<input type="radio" name="genero" id="o" value="otro" <?php print set_radio('genero','otro');?>> Otro<br><br>
		...
		<input type="checkbox" name="transporte[]" value="moto" <?php print set_checkbox('transporte[]','moto');?>> Motocicleta<br><br>
